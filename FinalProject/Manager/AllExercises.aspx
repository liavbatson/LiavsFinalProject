...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <asp:GridView ID="GridView1" runat="server" AllowPaging="True" AllowSorting="True" AutoGenerateColumns="False" DataKeyNames="Id" DataSourceID="SqlDataSource1" Width="80%" Height="80%">
        <Columns>
            ...
            <asp:BoundField DataField="subject" HeaderText="נושא" SortExpression="subject" />
            <asp:BoundField DataField="class" HeaderText="כיתה" SortExpression="class" />
            <asp:BoundField DataField="ex_image" HeaderText="ex_image" SortExpression="ex_image" />
