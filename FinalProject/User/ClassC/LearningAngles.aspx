...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <center>
        ...
        <p runat="server" id="firstP" style="font-size:25px;font-family: 'montserrat', sans-serif;display:none">
            ...
            <img src="../../Images/notAnAngle.png" /> <br />
            <img src="../../Images/firstAngle.png" /> <br />
            <img src="../../Images/secondAngle.png" /> <br />
            <img src="../../Images/thirdAngle.png" />
        </p>
        <h1 style="font-family: 'montserrat', sans-serif; font-size:80px;color:#0082e6">
        ...
        <p runat="server" id="secondP" style="font-size:25px;font-family: 'montserrat', sans-serif;display:none">
            ...
            <img src="../../Images/AngleA.png" /> <img src="../../Images/AngleB.png" /> <br />
            נניח את זווית ב' על גבי זווית א'. <br />
            נקפיד : קודקוד על קודקוד, קרן על קרן. <br />
            <img src="../../Images/AngleBonA.png" /> <br />
            ...
            <img src="../../Images/AngleA2.png" /> <img src="../../Images/AngleB2.png" /> <br />
            נניח את זווית ב' על גבי זווית א'. <br />
            נקפיד : קודקוד על קודקוד, קרן על קרן. <br />
            <img src="../../Images/AngleB2onA2.png" /> <br />
            ...
            <img src="../../Images/AngleA3.png" /> <img src="../../Images/AngleB3.png" /> <br />
            נניח את זווית ב' על גבי זווית א'. <br />
            נקפיד : קודקוד על קודקוד, קרן על קרן. <br />
            <img src="../../Images/AngleB3onA3.png" /> <br />
        ...
        <p runat="server" id="thirdP" style="font-size:25px;font-family: 'montserrat', sans-serif;display:none">
            ...
            <b> זווית ישרה -</b> <br />
            <img src="../../Images/RightAngle.png" /> <br />
            זווית א'  &nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp  זווית ב' <br />
            <img src="../../Images/AcuteAngle.png" /> <img src="../../Images/ObtuseAngle.png" /> <br />
            נשווה את הזוויות עם הזווית הישרה. <br />
            <img src="../../Images/AngleAcuteOnRight.png" /> <br />
            ...
            <img src="../../Images/AngleObtuseOnRight.png" /> <br />
            ...
            <img src="../../Images/FlatAngle.png" /> <br />
            לזווית זו קוראים זווית שטוחה. <br />
            זווית שטוחה = 180 מעלות = 90 + 90 <br />
            <img src="../../Images/AnglesComprasion.png" /> <br />
            <b> <span style="color:#0082e6">סיכום</span> </b> <br />
            ...
            <img src="../../Images/AnglesInTriangle.png" /> <br />
