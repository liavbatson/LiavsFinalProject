...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <center>
        ...
        <p runat="server" id="firstP" style="font-size:25px;font-family: 'montserrat', sans-serif;display:none">
            <img src="../../Images/SmallTriangle.png" /> <br />
        ...
        <p runat="server" id="thirdP" style="font-size:25px;font-family: 'montserrat', sans-serif;display:none">
            ...
            <img src="../../Images/3TrianglesWithAngles.png" /> <br />
            <b> משולש שמאלי - </b> <br />
            <img src="../../Images/TriangleAngles1.png" /> <br />
            זווית אחת ישרה ו-2 זוויות חדות. <br />
            <b> משולש אמצעי - </b> <br />
            <img src="../../Images/TriangleAngels2.png" /> <br />
            3 זוויות חדות. <br />
            <b> משולש ימני - </b> <br />
            <img src="../../Images/TriangleAngles3.png" /> <br />
            זווית אחת קהה ו-2 זוויות חדות. <br />
            לפנינו 7 משולשים - <br />
            <img src="../../Images/SevenTrianaglesAngles.png" /> <br />
        ...
        <p runat="server" id="fourthP" style="font-size:25px;font-family: 'montserrat', sans-serif;display:none">
            ...
            <img src="../../Images/SevenTrianglesBothSidesAndAngles.png" /> <br />
            <img src="../../Images/SortingTriananglesBySidesAndAngles.png" /> <br />
        </p>
    </center>
</asp:Content>