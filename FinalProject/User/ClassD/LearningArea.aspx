...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <center>
        ...
        <p runat="server" id="firstP" style="font-size:25px;font-family: 'montserrat', sans-serif;display:none">
            ...
            <img src="../../Images/RectArea.png" /> <br />
            ...
            <img src="../../Images/RecrSamar.png" /> <br />
        ...
        <p runat="server" id="secondP" style="font-size:25px;font-family: 'montserrat', sans-serif;display:none">
            ...
            <img src="../../Images/RectOne2.png" /> <br />
            נחשב את ההיקף : <br />
            ...
            <img src="../../Images/SquareTwo.png" /> <br />
            שטח הריבוע : <br />
            ...
            <img src="../../Images/RectThree.png" /> <br />
            שטח המלבן : <br />
