...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <center>
        ...
        <p runat="server" id="firstP" style="font-size:25px;font-family: 'montserrat', sans-serif;display:none">
            ...
            <img src="../../Images/Fgrade_img/polygons-nonpplygon.png" width="800" height="600" /> <br />
            <strong></strong>
        </p>
        </div>
        ...
        <p runat="server" id="secondP" style="font-size:25px;font-family: 'montserrat', sans-serif;display:none">
            <span style="color:#0082e6">מה משותף לגופים הבאים?  </span><br />
               <img src="../../Images/Fgrade_img/Shapes.png" width="800" height="600" /> <br />
            ...
            לחלקם כל הפאות הן מלבנים ולחלקם יש שתי פאות שהן <span style="color:#ff9900">מצולעים חופפים אחרים.</span><br />
               <img src="../../Images/Fgrade_img/color_shapes.png" width="800" height="600" /> <br /><br />
            כל הגופים האלה הם <span style="color:#009900">מנסרות. </span><br /><br />
               <img src="../../Images/Fgrade_img/shape_sentance.png" width="600" height="200" /> <br />
               <img src="../../Images/Fgrade_img/shape_a.png" width="800" height="600" /> <br />
            ...
            <img src="../../Images/Fgrade_img/shape_b.png" width="800" height="600" /> <br /><br />
            <img src="../../Images/Fgrade_img/shape_c.png" width="800" height="600" /> <br /><br />
            <img src="../../Images/Fgrade_img/shape_d.png" width="800" height="600" /> <br /><br />
            <img src="../../Images/Fgrade_img/shape_e.png" width="800" height="600" /> <br /><br />
            <img src="../../Images/Fgrade_img/shape_g.png" width="600" height="400" /> <br /><br />
            <img src="../../Images/Fgrade_img/shape_f.png" width="600" height="400" /> <br /><br />
            <strong>בסה"כ 18 צלעות. 3X6=18</strong><br /><br />
            <strong>מסקנות</strong><br /><br />
            <img src="../../Images/Fgrade_img/shape_h.png" width="600" height="400" /> <br /><br />
        ...
        <p runat="server" id="thirdP" style="font-size:25px;font-family: 'montserrat', sans-serif;display:none">
            ...
            <img src="../../Images/Fgrade_img/piramid_a.png" width="800" height="600" /> <br />
            <img src="../../Images/Fgrade_img/piramid_b.png" width="800" height="600" /> <br />
            <strong>שם הפירמידה נגזר  מצורת הבסיס:</strong><br />
            *בסיס משולש->פירמידה משולשת.<br />
            *בסיס מרובע->פירמידה מרובעת.<br />
            <img src="../../Images/Fgrade_img/piramid_c.png" width="600" height="300" /> <br />
            התשובה היא :4 פאות.<br />אחת בבסיס ו-3 משולשים(לפי צלעות הבסיס)<br />
            <img src="../../Images/Fgrade_img/piramid_d.png" width="600" height="300" /> <br />
            התשובה היא :6 פאות.<br />אחת בבסיס המחומש ו-5 משולשים(לפי צלעות הבסיס)<br />
            <img src="../../Images/Fgrade_img/piramid_e.png" width="600" height="300" /> <br />
            4 בבסיס + 1 שהוא קודקוד ראשי,כלומר בסך הכל :5 קודקודים.<br />
            <img src="../../Images/Fgrade_img/piramid_f.png" width="600" height="300" /> <br />
            3 בבסיס + 1 שהוא קודקוד ראשי,כלומר בסך הכל :4 קודקודים.<br /><br />
            <img src="../../Images/Fgrade_img/piramid_g.png" width="600" height="300" /> <br />
        ...
        <p runat="server" id="fourthP" style="font-size:25px;font-family: 'montserrat', sans-serif;display:none">
            ...
            <img src="../../Images/Fgrade_img/cone_a.png" width="700" height="600" /> <br />
            <img src="../../Images/Fgrade_img/cone_b.png" width="400" height="300" /> <br />
            <strong>ואם נפרוש את גוף ב' נקבל:חלק מעיגול(גזרה) ועיגול בצורה הבאה:</strong><br />
            <img src="../../Images/Fgrade_img/cone_c.png" width="400" height="300" /> <br />
            ...
            <img src="../../Images/Fgrade_img/cone_d.png" width="400" height="300" /> <br /><br />
            <img src="../../Images/Fgrade_img/cone_e.png" width="600" height="200" /> <br />
            לגוף זה יש בסיס בצורת מעגל,אך אין לו קודקוד ראשי ולכן <strong>אינו חרוט.</strong><br /><br />
            <img src="../../Images/Fgrade_img/cone_f.png" width="600" height="200" /> <br />
        ...
        <p runat="server" id="fifthP" style="font-size:25px;font-family: 'montserrat', sans-serif;display:none">
            ...
            <img src="../../Images/Fgrade_img/soppolygon_a.png" width="400" height="200" /> <br />
            ...
            <img src="../../Images/Fgrade_img/soppolygon_b.png" width="150" height="150" /> <br /><br />
            <img src="../../Images/Fgrade_img/soppolygon_c.png" width="500" height="400" /> <br /><br />
            ...
            <img src="../../Images/Fgrade_img/soppolygon_d.png" width="500" height="400" /> <br /><br />
        ...
        <p runat="server" id="sixthP" style="font-size:25px;font-family: 'montserrat', sans-serif;display:none">
            ...
            <img src="../../Images/Fgrade_img/role_a.png" width="800" height="600" /> <br />
            <img src="../../Images/Fgrade_img/role_b.png" width="800" height="600" /> <br />
            <img src="../../Images/Fgrade_img/role_c.png" width="600" height="200" /> <br /><br />
            <strong>שאלות להבנה</strong><br /><br />
            <img src="../../Images/Fgrade_img/role_d.png" width="700" height="400" /> <br /><br />
            <img src="../../Images/Fgrade_img/role_e.png" width="400" height="100" /> <br /><br />
            <img src="../../Images/Fgrade_img/role_f.png" width="800" height="600" /> <br /><br /><br />
            <img src="../../Images/Fgrade_img/role_g.png" width="800" height="600" /> <br />
